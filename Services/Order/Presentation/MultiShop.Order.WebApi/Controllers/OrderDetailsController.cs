...
namespace MultiShop.Order.WebApi.Controllers
{
    ...
    public class OrderDetailsController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateOrderDetail(CreateOrderDetailCommand command)
        {
            ...
            return Ok("Sipariş detayı başarıla eklendi");
        }
        [HttpDelete]
        public async Task<IActionResult>RemoveOrderDetail(RemoveOrderDetailCommand comamand)
        {
            await _removeOrderDetailCommandHandler.Handle(comamand);
